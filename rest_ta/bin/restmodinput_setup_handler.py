...
class ConfigHandler(splunk.admin.MConfigHandler):
    ...
    def handleList(self, confInfo):
        ...
        try:
            ...
            entities = entity.getEntities(['storage', 'passwords'], namespace="rest_ta", owner='nobody', sessionKey=self.getSessionKey())
            credential_list = []
            credential_key_list = []
    ...
    def handleEdit(self, confInfo):
        ...
        try:
            ...
            logger.debug(credential_key_str)
            logger.debug(credential_str)
