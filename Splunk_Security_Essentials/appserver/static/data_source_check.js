...
function doDataCheck(element) {
    ...
    /*else{//} if(($("#data_check_test-" + element + "-" + i).find("img")[0].src.indexOf("queue_icon.gif")>0) && (window.SearchesInQueue.length>0)){
                                $("#" + element).html("<img style=\"height:22px; width:20px;\" src=\"" + Splunk.util.make_full_url("/static/app/Splunk_Security_Essentials/images/general_images/" + status + "") + "\">")
                            }*/
...
function GenerateDashboardModals() {
    ...
    require(['jquery', 'app/Splunk_Security_Essentials/components/controls/UnattachedModal'], function($, Modal) {
