                    ...
                    sm.on('search:done', function(properties) {
                        ...
                        smResults.on("data", function(properties) {
                            ...
                            if (typeof data[0] != "undefined" && typeof data[0].ESCU != "undefined") {
                                ...
                                if (typeof data[0].ES != "undefined" && data[0].ES.indexOf("5.") == 0) {
                                    isESInstalled = true;
                                }
                                    ...
                                    storyDetailssmResults.on("data", function(properties) {
                                        ...
                                        for (var i = 0; i < data.length; i++) {
                                            ...
                                            var launchLink = $('<button style="float: right;" class="btn btn-primary">Open in ESCU <i class="icon-external" /></button>').click(function() {
                                                let link = '/app/DA-ESS-ContentUpdate/analytic_story_details?form.analytic_story_name=';
                                                if (isESInstalled) {
                                                    link = '/app/SplunkEnterpriseSecuritySuite/ess_analytic_story_details?analytic_story='; //https://localhost:8000/en-US/app/SplunkEnterpriseSecuritySuite/ess_analytic_story_details?analytic_story=AWS%20Cross%20Account%20Activity
                                                }
                                                window.open(
                                                    Splunk.util.make_full_url(link + storyName),
                                                    '_blank'
                                                );
                                            })
