...
require(['jquery',
    ...
    // $("#container").append( $('<button class="btn btn-primary" style="margin:10px;">Re-read Data!</button>').click(function(){ 
    ...
    //         var myModal = new Modal("refreshModal", {
    //             title: "Bump",
    //             backdrop: 'static',
    //             keyboard: false,
    //             destroyOnHide: true,
    ...
    //         })
    //         myModal.body
    //             .append( $("<p>This page makes direct changes to the filesystem. Those changes don't get re-read except with a _bump, which means you need to physically click the button below (and watch the number go up!) before you'll see any of your changes. Sometimes Splunk is a pain /shrug. </p>"), $('<iframe src="/en-US/_bump" />'));
    ...
    //     })
    // }))
    $("#container").append($('<button class="btn btn-primary" style="margin:10px;">Data Source Categories</button>').click(function() {
        makeItHappen("eventtypes");
        $("#container").html("<h1>Loading...</h1>")
    })), $("#container").append($('<button class="btn btn-primary" style="margin:10px;">MITRE</button>').click(function() {
        makeItHappen("mitre");
        $("#container").html("<h1>Loading...</h1>")
...
function makeItHappen(what_are_we_doing) {
    ...
    require(['jquery',
        ...
        'json!vendor/mitre/enterprise-attack.json',
        'json!vendor/mitre/pre-attack.json',
...
function triggerError(textStatus) {
    ...
    require(['jquery',
        ...
        myModal.body
            .append($("<h3>Got an error saving your change:</h3>"), $("<p>").text(textStatus));
